...
#define BETTER_PAINT_VERSION       "0.1.1"
#define BETTER_PAINT_VERSION_NUM   1100
...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(bool* p_open = NULL, int width = 0, int height = 0);        // create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
